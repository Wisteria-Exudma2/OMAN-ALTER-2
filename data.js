...
const CLASS_DATA = {
  warrior: {
    name: "Warrior", icon: "⚔️", image: "assets/class-warrior.jpg",
  ...
  mage: {
    name: "Mage", icon: "✨", image: "assets/class-mage.jpg",
  ...
  archer: {
    name: "Archer", icon: "🏹", image: "assets/class-archer.jpg",
  ...
  priest: {
    name: "Priest", icon: "✝️", image: "assets/class-priest.jpg",
    role: "Healer & Support",
  ...
  guardian: {
    name: "Guardian", icon: "🛡️", image: "assets/class-guardian.jpg",
    role: "Tank & Protector",
...
// ─── RACE DATA ────────────────────────────────────────────────
const RACE_DATA = [
  { id: "human",      name: "Human",      emoji: "👤", image: "assets/race-human.jpg",      hp: 50, mp: 20, trait: "Adaptasi Cepat",    traitDesc: "Dapat berganti class setelah Level 30 tanpa penalti besar",                          bonus: "+5 semua stat dasar",  color: "#e8dcc8", lore: "Manusia adalah ras paling adaptif di Oman. Kemampuan mereka untuk belajar dan beradaptasi membuat mereka unggul di semua bidang." },
  { id: "elf",        name: "Elf",        emoji: "🧝", image: "assets/race-elf.jpg",        hp: 25, mp: 45, trait: "Mata Elang",        traitDesc: "Serangan jarak jauh +15% akurasi dan +10% CRIT",                                      bonus: "+10 INT, +10 AGI",     color: "#81c784", lore: "Elf hidup ribuan tahun dalam harmoni dengan alam dan sihir. Telinga lancip mereka menangkap bisikan angin yang membawa rahasia dunia." },
  { id: "dwarf",      name: "Dwarf",      emoji: "⛏️", image: "assets/race-dwarf.jpg",      hp: 60, mp: 10, trait: "Kulit Besi",        traitDesc: "PHYS DEF +20%, tidak bisa di-knockback",                                              bonus: "+15 VIT, +10 STR",     color: "#b87333", lore: "Dwarf adalah ahli tempa dan penambang ulung. Tubuh mereka yang kokoh seperti batu gunung tempat mereka tinggal." },
  { id: "wolfkin",    name: "Wolfkin",    emoji: "🐺", image: "assets/race-wolfkin.jpg",    hp: 45, mp: 25, trait: "Insting Predator",  traitDesc: "CRIT DMG +25%, bonus +10 AGI saat HP < 50%",                                          bonus: "+10 STR, +10 AGI",     color: "#78909c", lore: "Keturunan serigala kuno yang berevolusi menjadi ras humanoid. Naluri berburu mereka tajam dan naluri kawanan mereka kuat." },
  { id: "darkelf",    name: "Dark Elf",   emoji: "🌑", image: "assets/race-darkelf.jpg",    hp: 35, mp: 35, trait: "Bayangan Abadi",    traitDesc: "Dapat menghilang 1 ronde (tidak bisa diserang), CD 5 ronde",                          bonus: "+10 AGI, +10 INT",     color: "#7b2d8b", lore: "Dark Elf hidup di kegelapan dan menguasai seni ilusi serta racun. Mereka adalah master stealth yang ditakuti di seluruh Oman." },
  { id: "dragonborn", name: "Dragonborn", emoji: "🐉", image: "assets/race-dragonborn.jpg", hp: 55, mp: 30, trait: "Napas Naga",        traitDesc: "1x per pertarungan: serangan AOE yang mengabaikan DEF musuh",                         bonus: "+12 STR, +8 VIT",      color: "#d32f2f", lore: "Keturunan langsung dari naga kuno. Darah naga dalam tubuh mereka memberi kekuatan luar biasa dan napas api yang menghancurkan." },
  { id: "faeborn",    name: "Faeborn",    emoji: "🧚", image: "assets/race-faeborn.jpg",    hp: 20, mp: 50, trait: "Sihir Peri",        traitDesc: "Semua skill sihir -1 AP cost, tidak bisa minimum di bawah 1",                         bonus: "+15 INT, +10 SPI",     color: "#e91e63", lore: "Ras yang lahir dari alam peri, tempat sihir mengalir seperti air. Tubuh mereka rapuh namun potensi sihir mereka tak tertandingi." },
  { id: "beastkin",   name: "Beastkin",   emoji: "🦁", image: "assets/race-beastkin.jpg",   hp: 50, mp: 15, trait: "Fury Form",         traitDesc: "Saat HP < 30%, semua stat fisik +30% selama 3 ronde",                                 bonus: "+12 STR, +8 AGI",      color: "#f57c00", lore: "Beastkin adalah gabungan manusia dan hewan buas. Mereka bertempur dengan naluri binatang yang memuncak saat terdesak." },
  { id: "undead",     name: "Undead",     emoji: "💀", image: "assets/race-undead.jpg",     hp: 40, mp: 30, trait: "Jiwa Abadi",        traitDesc: "1x per pertarungan: bertahan dengan 1 HP saat menerima serangan yang harusnya KO",     bonus: "+10 VIT, +10 SPI",     color: "#546e7a", lore: "Ras yang kembali dari kematian. Mereka membawa ketenangan abadi dan ketahanan terhadap kematian yang membuat musuh-musuh mereka gemetar." },
  { id: "celestial",  name: "Celestial",  emoji: "⭐", image: "assets/race-celestial.jpg",  hp: 30, mp: 45, trait: "Berkat Bintang",    traitDesc: "Setiap 3 ronde, regenerasi 10% HP & MP",                                              bonus: "+10 INT, +10 SPI",     color: "#ffd54f", lore: "Keturunan makhluk langit yang turun ke Oman. Mereka memancarkan cahaya bintang dan membawa berkah ilahi kepada sesama." },
];

// ─── FACTION DATA ─────────────────────────────────────────────
const FACTION_DATA = [
  { id: "aurelian", name: "Aurelian Empire",   icon: "👑", image: "assets/faction-aurelian.png",  region: "Barat Laut — Gurun Emas",           color: "#d4a843", accent: "#ffd700", desc: "Kerajaan megah yang berdiri di atas pasir emas. Aurelian Empire menguasai jalur perdagangan terbesar dan memiliki militer paling terlatih.",                                     buff: "Gold Advantage: semua transaksi Zen +10%",                              pros: ["Akses pasar eksklusif", "Militer terlatih", "Diplomasi kuat"],               cons: ["Pajak tinggi untuk member", "Konflik dengan Shadow"],                 allies: ["Ironforge Guild"],              enemies: ["Shadow Covenant", "Void Council"] },
  { id: "shadow",   name: "Shadow Covenant",   icon: "🌑", image: "assets/faction-shadow.png",    region: "Timur Laut — Kota Bawah Tanah",     color: "#7b2d8b", accent: "#ce93d8", desc: "Organisasi rahasia yang beroperasi dari kota bawah tanah. Shadow Covenant menguasai jaringan intel dan perdagangan gelap Oman.",                                              buff: "Stealth Bonus: semua aksi bisa skip 1 giliran musuh 1x/pertarungan",    pros: ["Intel terbaik", "Jaringan luas", "Skill assassin eksklusif"],         cons: ["Reputasi buruk", "Musuh banyak"],                                     allies: ["Void Council"],                 enemies: ["Aurelian Empire", "Crimson Crusade"] },
  { id: "arcane",   name: "Arcane Consortium", icon: "🔮", image: "assets/faction-arcane.png",    region: "Tengah-Utara — Menara Terapung",    color: "#00acc1", accent: "#4fc3f7", desc: "Persekutuan para penyihir dan ilmuwan yang bermukim di menara terapung. Arcane Consortium menguasai ilmu sihir tertinggi di Oman.",                                         buff: "Magic Mastery: semua skill INT +15% damage",                            pros: ["Research & crafting terbaik", "Library sihir", "Neutral stance"],     cons: ["Biaya keanggotaan mahal", "Jarang terlibat perang"],                  allies: ["Wildlands Pact"],               enemies: ["Void Council"] },
  { id: "wildlands",name: "Wildlands Pact",    icon: "🌿", image: "assets/faction-wildlands.png", region: "Barat — Padang Rumput Luas",        color: "#2e7d32", accent: "#81c784", desc: "Aliansi suku-suku bebas yang hidup menyatu dengan alam. Wildlands Pact menguasai pengetahuan alam, racun, dan kemampuan bertahan hidup.",                                   buff: "Nature Bond: HP regen +5 per ronde di luar dungeon",                    pros: ["Taming beast mounts", "Herbalism & alchemy", "Anti-tracking"],        cons: ["Tidak bisa tinggal di kota", "Teknologi terbatas"],                   allies: ["Arcane Consortium"],            enemies: ["Ironforge Guild"] },
  { id: "ironforge", name: "Ironforge Guild",  icon: "⚒️", image: "assets/faction-ironforge.png", region: "Tengah-Selatan — Kota Tempa",       color: "#795548", accent: "#ff6a00", desc: "Guild pandai besi dan insinyur terbesar di Oman. Ironforge Guild memproduksi equipment terbaik dan senjata paling mematikan.",                                             buff: "Mastercraft: semua equipment dari Ironforge +10% stat bonus",           pros: ["Crafting tier tertinggi", "Equipment diskon", "Netral secara politik"],cons: ["Mahal bergabungnya", "Mobilitas rendah"],                              allies: ["Aurelian Empire"],              enemies: ["Wildlands Pact"] },
  { id: "crimson",  name: "Crimson Crusade",   icon: "⚔️", image: "assets/faction-crimson.png",   region: "Tenggara — Benteng Militer",        color: "#c62828", accent: "#ef9a9a", desc: "Pasukan perang fanatik yang menguasai benteng militer di tenggara. Crimson Crusade hidup untuk perang dan memenangkannya.",                                                  buff: "War Fury: PHYS ATK +10%, +5% setiap ronde bertahan",                    pros: ["PvP specialist", "Dungeon clearing cepat", "Glory points bonus"],     cons: ["Tidak bisa menolak tantangan duel", "Reputasi agresif"],              allies: ["Aurelian Empire"],              enemies: ["Shadow Covenant", "Wildlands Pact"] },
  { id: "void",     name: "Void Council",      icon: "🌀", image: "assets/faction-void.png",      region: "Jauh Timur — Tanah Terkorupsi",     color: "#1565c0", accent: "#90caf9", desc: "Dewan penguasa dimensi kekosongan. Void Council memanipulasi realita dan waktu, membuat mereka menjadi faksi paling misterius dan berbahaya.",                              buff: "Void Touch: 20% chance setiap serangan memicu extra damage void",       pros: ["Skill unik eksklusif", "Time manipulation", "Lore terlengkap"],       cons: ["Dipandang sebagai ancaman", "Quest khusus sangat sulit"],             allies: ["Shadow Covenant"],              enemies: ["Arcane Consortium", "Aurelian Empire"] },
];
...
const SKILL_GUIDE_DATA = [
  ...
  },
  {
    ...
    contohSkill: [
      ...
      { kelas: "Priest",   name: "Quick Mend", desc: "Heal ringan satu target" },
